...
static inline void scale2DMat(float* mat4, Vec2D vec) {

	float destMat4[16];

	destMat4[0] = mat4[0] * vec.x;	destMat4[4] = mat4[4] * vec.y;
	destMat4[1] = mat4[1] * vec.x;	destMat4[5] = mat4[5] * vec.y;
	destMat4[2] = mat4[2] * vec.x; 	destMat4[6] = mat4[6] * vec.y;
	destMat4[3] = mat4[3] * vec.x;	destMat4[7] = mat4[7] * vec.y;
